...
const Feedback = () => {
  ...
  return (
    <div className="relative w-full h-[1024px] overflow-hidden text-left text-[24px] text-dimgray font-inter">
    <div className="absolute top-[calc(50%_-_534px)] left-[calc(50%_-_730px)]  w-[1450px] h-[1046px] overflow-hidden">
      <div className="absolute top-[calc(50%_-_251px)] left-[calc(50%_-_402px)] rounded-3xl bg-gray-100 bg-opacity-5 shadow-[0px_60px_220px_rgba(0,_0,_0,_0.35)] w-[891px] h-[631px]" />
      <div className="absolute top-[calc(50%_-_221px)] left-[calc(50%_-_362px)] rounded-3xl [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.8),_#fff)] shadow-[0px_1px_4px_rgba(0,_0,_0,_0.05)] w-[830px] h-[582px]">
        <div className="absolute h-[calc(100%_+_9px)] top-[-8.64px] right-[20px] bottom-[-0.36px] w-[177px] overflow-hidden">
        </div>
        ...
        <div className="absolute h-[calc(100%_-_529px)] top-[509px] bottom-[20px] left-[537px] rounded-3xl [background:linear-gradient(-86.58deg,_#7000ff,_#b134ff)] shadow-[0px_0.7226200103759766px_0.72px_-1.25px_rgba(0,_0,_0,_0.18),_0px_2.7462399005889893px_2.75px_-2.5px_rgba(0,_0,_0,_0.16),_0px_12px_12px_-3.75px_rgba(0,_0,_0,_0.06)] w-[273px] overflow-hidden text-xl text-white">
          ...
          <div className="absolute top-[12px] left-[41px] tracking-[-0.1px] leading-[28px] font-semibold">
            Generate New Prompt
          </div>
          <img
            className="absolute top-[calc(50%_-_14.5px)] left-[calc(50%_-_128.5px)] w-[30px] h-[30px]"
            alt=""
            src="/divframerceuir2.svg"
          />
        </div>
      </div>
